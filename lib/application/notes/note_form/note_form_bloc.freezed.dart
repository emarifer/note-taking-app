...
class _$BodyChanged implements BodyChanged {
  const _$BodyChanged({required this.bodyStr});
...
abstract class BodyChanged implements NoteFormEvent {
  const factory BodyChanged({required final String bodyStr}) = _$BodyChanged;
...
class _$ColorChanged implements ColorChanged {
  const _$ColorChanged({required this.color});
...
abstract class ColorChanged implements NoteFormEvent {
  const factory ColorChanged({required final Color color}) = _$ColorChanged;
...
class _$TodosChanged implements TodosChanged {
  const _$TodosChanged({required this.todos});
...
abstract class TodosChanged implements NoteFormEvent {
  const factory TodosChanged({required final KtList<TodoItemPrimitive> todos}) =
      _$TodosChanged;
...
abstract class _NoteFormState implements NoteFormState {
  ...
  @override // A diferencia de SignInFormState, aquí tenemos una entidad
// que podemos usar fácilmente para la validación en lugar de almacenar
// los campos individuales de los "value objects" que la constituyen. VER NOTA ABAJO:
  Note get note => throw _privateConstructorUsedError;
  @override
